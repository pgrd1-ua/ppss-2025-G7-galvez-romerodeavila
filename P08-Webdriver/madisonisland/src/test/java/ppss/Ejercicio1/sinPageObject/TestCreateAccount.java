...
public class TestCreateAccount {
    ...
    @BeforeEach
    public void setUp() {
        System.setProperty("webdriver.chrome.driver", "/home/ppss/chromedriver/chromedriver");
    ...
    public void S1_scenario_createAccount_should_create_new_account_in_the_demo_store_when_this_account_does_not_exist() throws NoSuchElementException {
        ...
        driver.findElement(By.cssSelector(".skip-account.skip-link")).click();
        ...
        //driver.findElement(By.cssSelector("a[title='Create an Account']")); Ahora voy a probar la otra opcion
        ...
        driver.findElement(By.id("lastname")).sendKeys("Galvez Romero");
